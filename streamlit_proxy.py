#!/usr/bin/env python3
"""
Simple proxy server for Streamlit without password protection
"""
...
class StreamlitProxyHandler(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        try:
...
def start_proxy_server():
    ...
    with socketserver.TCPServer(("0.0.0.0", PORT), StreamlitProxyHandler) as httpd:
        print(f"🌐 Streamlit proxy running on port {PORT}")
