...
class TestDataProcessingEdgeCases:
    ...
    def test_calculate_monthly_budget_with_future_dates(self):
        ...
        expenses_df = pd.DataFrame(
            {"שקלים": [100, 200], "תאריך": ["2025-01-01", "2025-01-02"]}  # Future dates
        )
        donations_df = pd.DataFrame({"שקלים": [500, 600], "תאריך": ["2025-01-01", "2025-01-02"]})
    ...
    def test_calculate_monthly_budget_with_zero_values(self):
        ...
        expenses_df = pd.DataFrame(
            {"שקלים": [0, 100, 0], "תאריך": ["2024-01-01", "2024-01-02", "2024-01-03"]}
        )
        donations_df = pd.DataFrame(
            {"שקלים": [500, 0, 300], "תאריך": ["2024-01-01", "2024-01-02", "2024-01-03"]}
        )
    ...
    def test_calculate_monthly_budget_with_invalid_dates(self):
        ...
        expenses_df = pd.DataFrame({"שקלים": [100, 200], "תאריך": ["invalid-date", "2024-01-02"]})
        donations_df = pd.DataFrame({"שקלים": [500, 600], "תאריך": ["2024-01-01", "invalid-date"]})
