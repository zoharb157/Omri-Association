...
class TestServices(unittest.TestCase):
    ...
    def test_sheets_service_import(self):
        ...
        try:
            from services.sheets import load_all_data
...
class TestUIComponents(unittest.TestCase):
    ...
    def test_simple_ui_import(self):
        ...
        try:
            from ui.components.simple_ui import create_simple_metric_row, create_simple_section_header
    ...
    def test_layout_system_import(self):
        ...
        try:
            from ui.components.layout_system import create_section_header, create_metrics_grid
