...
# Set page config
st.set_page_config(page_title="Test Fixed Metrics", page_icon="🔧", layout="wide")
...
# Test data
test_metrics = [
    {"label": "אחוז ניצול", "value": "85%", "help": "אחוז ניצול התקציב", "color": "primary"},
    {"label": "יתרה זמינה", "value": "₪15,000", "help": "יתרה זמינה לתקציב", "color": "success"},
    {"label": "סך הוצאות", "value": "₪45,000", "help": "סך הוצאות החודש", "color": "warning"},
    {"label": "סך תרומות", "value": "₪60,000", "help": "סך תרומות החודש", "color": "info"},
]
